...
const articles = [
  ...
  },
  {
    ...
    articleLink:
      "https://www.active.com/fitness/articles/are-dog-owners-healthier-people",
  },
  {
    ...
    articleLink:
      "https://pets.webmd.com/dogs/adoption-21/slideshow-best-dog-breed-for-your-health",
  },
];
  ...
  return (
    <div className="bg-[#fff2d9]">
      ...
      <Head>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Dosis:wght@400;700&family=Titillium+Web&display=swap"
          rel="stylesheet"
        />
      </Head>
      ...
      <header
        className="bg-[#ff7931] sticky top-0 heading"
        style={{ zIndex: 100 }}
      >
              ...
              {incentives.map((incentive) => (
                <div key={incentive.name} className="sm:flex lg:block">
                  ...
                  <div className="mt-4 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
                    <h3 className="text-sm text-gray-900">{incentive.name}</h3>
          ...
          <div>
            <div className={classes.demo2}>
              ...
              >
                ...
                <StyledTab
                  label="Low Commitment Puppy Time"
                  {...a11yProps(1)}
                />
              </StyledTabs>
              <TabPanel value={value} index={0}>
                <div className="adopt-box">
                  <div>
                    <span className="low-com-blurb">
                      {" "}
                      <b> Can't wait to meet your furry little friend? </b>
                      <br /> Although you can purchase a pup from a pet store or
                      a dog breeder, adopting from an animal shelter is often
                      much more <br /> affordable and gives you the opportunity
                      to provide a lonely pup with a loving home. Get your
                      adoption journey rolling by <br /> exploring different
                      breeds and finding dogs that need homes near you.{" "}
                    </span>
                    ...
                    <div className="card-container-adopt">
                      <span className="bound-width">
                        <div className="flex flex-col rounded-lg shadow-lg overflow-hidden lim-width">
                          <img
                            src="https://i.ibb.co/NLqRD2C/labsterriers.png"
                            alt="lab, terrier, and a beagle illustration"
                          />
                          <div className="flex-1 bg-white p-6 flex flex-col justify-between">
                            <div className="flex-1">
                              <p className="dosis text-xl font-bold text-[#ff7931]">
                                {" "}
                                Labs &amp; Terriers &amp; Beagles, Oh My!{" "}
                              </p>
                              <a className="block mt-2">
                                <p className="text-base font-semibold text-gray-900">
                                  Let's do some digging to figure out the best
                                  dog for you.
                                </p>
                                <p className="mt-3 text-sm  text-gray-500">
                                  Explore the{" "}
                                  <a
                                    className="learn-more-2"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                  ...
                                  from the American Kennel Club to get a feel
                                  for all the kinds of pups that are out there.
                                  Check out the range of personalities, and see
                                  how they match up with other factors you may
                                  care about like shedding, barking, and size.
                                  To many variables to keep straight? Take the
                                  Kennel Club's breed matching quiz for more
                                  insights.
                                </p>
                              </a>
                            </div>
                        ...
                        <div className="flex flex-col rounded-lg shadow-lg overflow-hidden lim-width">
                          ...
                          <div className="flex-1 bg-white p-6 flex flex-col justify-between">
                            <div className="flex-1">
                              <p className="dosis text-xl font-bold text-[#ff7931]">
                                {" "}
                                Scour Shelters Near You in Seconds{" "}
                              </p>
                              <a className="block mt-2 mb-3">
                                <p className="text-base font-semibold text-gray-900">
                                  Shelters publish pups for adoption online-
                                  expedite your search by starting remotely.
                                </p>
                                <p className="mt-3 text-sm text-gray-500">
                                  Tools that aggregate dogs for adoption across
                                  animal welfare groups, rescue teams, and pet
                                  shelters are particularly helpful for quickly
                                  identifying potential pups. Filter for dogs
                                  who fit your lifestyle, make a shortlist, and
                                  then start meeting them in person to see if
                                  there is a match!
                                </p>
                              </a>
                            </div>
                            <p className="shelter-button">
                              <ColorButton
                                ...
                                onClick={() => {
                                  window.open(
                                    "https://www.petfinder.com/search/dogs-for-adoption/us/ca/stanford/?sort%5B0%5D=recently_added",
                                    "_blank"
                                  );
                                }}
                              >
                                Nearby Pups to Adopt
                              </ColorButton>
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="checklist">
                        <img
                          src="https://i.ibb.co/QP2t3tQ/adoption-checklist.png"
                          alt="adoption checklist"
                        />
                        <SecondaryButton
              ...
              <TabPanel value={value} index={1}>
                <div className="low-com-box">
                  <div>
                    <span className="low-com-blurb">
                      {" "}
                      <b>Let's keep the relationship low-key for now. </b>{" "}
                      <br />
                      Adopting a pup is not a decision that should be made
                      lightly. Owning a dog represents an important commitment
                      of time, money, and energy. Even if adopting isn't the
                      right choice for you now,
                      <b>
                        {" "}
                        there are other ways to get the benefits and wellbeing
                        boosts from some puppy love!{" "}
                      </b>{" "}
                      <br />{" "}
                    </span>
                      ...
                      <div className="flex flex-col rounded-lg shadow-lg overflow-hidden lim-width">
                        ...
                        <div className="flex-1 bg-white p-6 flex flex-col justify-between">
                          <div className="flex-1">
                            ...
                            <a className="block mt-2">
                              <p className="text-base font-semibold text-gray-900">
                                Boost your happiness and your bank account by
                                walking and caring for other people's dogs.
                              </p>
                              <p className="mt-3 text-sm  text-gray-500">
                                Apps exist to connect dog lovers with nearby
                                pups. Over 350k people in the US have used{" "}
                                <a
                      ...
                      <div className="flex flex-col rounded-lg shadow-lg overflow-hidden lim-width">
                        ...
                        <div className="flex-1 bg-white p-6 flex flex-col justify-between">
                          <div className="flex-1">
                            ...
                            <a className="block mt-2 mb-3">
                              <p className="text-base font-semibold text-gray-900">
                                Volunteer at a local pet shelter or with a
                                rescue organization.
                              </p>
                              <p className="mt-3 text-sm text-gray-500">
                                You can get involved in your local community and
                                help out doggos in need through volunteer work.
                                Volunteer programs can vary by shelter and can
                                include anything from drop-in{" "}
                                <a
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="learn-more-2"
                                  href="https://www.spcamc.org/how-to-help/volunteer/title/hug-a-pet"
                                >
                                  {" "}
                                  "hug a pet"{" "}
                                </a>
                                ...
                                <a
                                  ...
                                  rel="noopener noreferrer"
                                  className="learn-more-2"
                                  href="https://www.sfspca.org/get-involved/volunteer/info-sessions-calendar/"
                                >
                                  weekly commitments
                                </a>{" "}
                                to at-home{" "}
                                <a
                                  ...
                                  rel="noopener noreferrer"
                                  className="learn-more-2"
                                  href="https://www.hssv.org/volunteer/foster-an-animal/#fosterdogpuppy"
                                >
                                  dog fostering{" "}
                                </a>{" "}
                                programs. The right program for you may depend
                                on your experience and comfort working with
                                rescue pups.
                              </p>
                            </a>
                          </div>
                  ...
                  <img
                    className="stress-dog"
                    src="https://i.ibb.co/myzpvLQ/stress-Dog.png"
                    alt="Cartoon dog sitting down discussing stress science."
                  />
                </div>
              </TabPanel>
              <Typography className={classes.padding} />
